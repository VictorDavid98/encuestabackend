...
public class UserControllerTests {
    ...
    @Test
    public void createUser_conUsuarioValidoConCorreoElectronicoValido_retornaBadRequest(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
    ...
    @Test
    public void createUser_conUsuarioValidoConCorreoElectronicoValido_retornaMensadeDeErrorDeValidacionParaElEmail(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        register(user, UserRest.class);
    ...
    @Test
    public void getUser_sinTokenDeAutenticacion_retornaMensadeForbidden(){
